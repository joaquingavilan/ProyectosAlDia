...
urlpatterns = [
    ...
    path('ver_encargados_deposito', views.ver_encargados_deposito, name='ver_encargados_deposito'),
    path('editar_encargado/<int:pk>/', views.editar_encargado_deposito, name='editar_encargado'),
    path('get_encargado_data/<int:encargado_id>/', views.get_encargado_data, name='get_encargado_data'),
    path('eliminar_encargado/<int:pk>/', views.eliminar_encargado, name='eliminar_encargado'),
    path('buscar_encargados/', views.buscar_encargados, name='buscar_encargados'),
    path('ver_encargado/<int:id_encargado>/', views.ver_encargado, name='ver_encargado'),
    path('registrar_encargado/', views.registrar_encargado, name='registrar_encargado'),
    path('ver_administradores', views.ver_administradores, name='ver_administradores'),
    path('editar_administrador/<int:pk>/', views.editar_administrador, name='editar_administrador'),
    path('eliminar_administrador/<int:pk>/', views.eliminar_administrador, name='eliminar_administrador'),
    path('buscar_administrador/', views.buscar_administrador, name='buscar_administrador'),
    path('ver_administrador/<int:id_administrador>/', views.ver_administrador, name='ver_administrador'),
    path('registrar_administrador/', views.registrar_administrador, name='registrar_administrador'),
