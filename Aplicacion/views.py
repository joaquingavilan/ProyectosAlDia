...
def ver_administradores(request):
    group_encargado = Group.objects.get(name='ADMINISTRADOR')
    encargados = group_encargado.user_set.all()
    ...
    return render(request, 'pantallas_gerente/ver_administradores.html', {'page_obj': page_obj})
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if not form.errors:
                ...
                return redirect('ver_administradores')
        else:
            return redirect('ver_administradores')
        ...
        form = CustomUserCreationForm()
        no_obligatorios = ['Teléfono', 'Dirección']
        return render(request, 'pantallas_gerente/registrar_administrador.html',
                      {'form': form, 'no_obligatorios': no_obligatorios})



def ver_administrador(request, id_administrador):
    administrador = User.objects.get(pk=id_administrador)
    return render(request, 'pantallas_gerente/ver_administrador.html', {'encargado': administrador})
...
def eliminar_administrador(request, pk):
    ...
    return render(request, 'pantallas_gerente/eliminar_administrador.html', context)
